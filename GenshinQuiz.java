...
public class GenshinQuiz {
    ...
    public static String [] questions = {
        ...
        "In Genshin Impact, what are the trinkets that element wielders?",
    ...
    public static String [] choices = {
        "Mora | Resin | Primogems | Tokens",
        "Vision | Artifact | Weapon | Accessory",
        "Pyro | Electro | Cryo | Hydro",
        "Sacrificial Sword | Amber Pearl | Wolf's Gravestone | The Stringless",
        "Sangonomiya Kokomi | Wanderer | Diluc | Qiqi",
    };    
